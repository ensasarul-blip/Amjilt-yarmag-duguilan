-- =====================================================================
--  05. ШАТЛАСАН БҮРТГЭЛ (түвшин бүр өөр өдөр)
--
--  ⚠️ Supabase -> SQL Editor -> New query -> энэ файлыг БҮТНЭЭР нь
--     хуулж тавиад -> Run.
--
--  Хийх зүйл:
...
--
--  Дахин ажиллуулсан ч аюулгүй. Аль хэдийн байгаа огноог дарж бичихгүй.
-- =====================================================================
...
-- Хүснэгтийн түвшний эрх (RLS-ээс тусдаа — хоёулаа шаардлагатай)
grant usage on schema public to anon, authenticated;
grant select on public.level_schedule to anon, authenticated;
grant select, insert, update, delete on public.level_schedule to authenticated;
...
-- ---------------------------------------------------------------------
-- 5. Хуваарийг бөглөнө (Улаанбаатарын цагаар)
--      Бага  — 2026-09-21 Даваа
--      Дунд  — 2026-09-22 Мягмар
--      Ахлах — 2026-09-23 Лхагва
--    Огноог дараа нь админ самбараас өөрчилж болно.
-- ---------------------------------------------------------------------
